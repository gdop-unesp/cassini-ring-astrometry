...
;-------------------------------------------------------------------------------
PRO radec2pix, ra, dec, sample, line, CORRECT_STELAB=vobs
	...
	rho_cam = image.matinv##rho_J2000
	...
	sl = image.kmat ## [[x],[y],[x*y]]
	sample = -(sl[*,0] - image.center[0])/image.bin
	line   = -(sl[*,1] - image.center[1])/image.bin
